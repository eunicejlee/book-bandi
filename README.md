...
| `app.v4.js` | React 앱 본체 (번들 완료, 빌드 불필요) |
...
1. 번들 파일 이름 : `app.v4.js` → `app.v5.js`
2. `index.html` 안의 `<script src="./app.v4.js">` → `./app.v5.js`
3. `sw.js` 맨 위 `const VERSION = "v4"` → `"v5"`, 목록의 `"./app.v4.js"` → `"./app.v5.js"`
...
1. 설정 화면 맨 아래 버전이 `책반디 v1.3` 인지 본다 (아니면 예전 파일)
